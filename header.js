          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="Personal.html">Personal Information</a>
                  <a class="dropdown-item" href="areas.html">Areas of Special Interest</a>
                  <a class="dropdown-item" href="employment.html">Current and Previous Employments</a>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="sfc.html">State Commissions Reports</a>
